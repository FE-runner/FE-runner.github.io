                        ...
                        d.onclick = function() {
                            ...
                            script.onload = script.onreadystatechange = function() {
                                if (!this.readyState || this.readyState === "loaded" || this.readyState === "complete") {
                                    ...
                                    iImgObj.src = sendClickUrl + '?channel_id=' + a + '&banner_id=' + b + '&ad_id=' + strlistdate + '&tas_code=' + tas_code + '&ad_url=' + encodeURIComponent(strHref) + '&js_type=1&click_type=gaojiyundong-lunbotu&t=' + (new Date()).getTime()
                                    script.onload = script.onreadystatechange = null;

                                    if (UrlHost == "x5.qq.com" || UrlHost == "cf.qq.com") {
                                        var ShowAdClick = a + "." + b + "." + strlistdate + "." + tas_code;
                                        var ShowAdClickUrl = LogCgi + '?m=SendLog&show_ads=' + ShowAdClick + '&ad_url=' + encodeURIComponent(strHref) + '&click_type=gaojiyundong-lunbotu&t=' + (new Date()).getTime();
